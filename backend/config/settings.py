"""
Django settings for Artist Commission Dashboard.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('MYSQL_DATABASE', 'artist_commission_db'),
        'USER': os.getenv('MYSQL_USER', 'commission_user'),
        'PASSWORD': os.getenv('MYSQL_PASSWORD', 'commission_password'),
